...
class PluginStructureTest(unittest.TestCase):
    ...
    def test_general_view_uses_native_general_endpoint_and_has_zone_link(self):
        ...
        self.assertIn("updateServiceControlUI('powerdns')", view)
        self.assertIn("partial('layout_partials/base_apply_button'", view)
        self.assertIn("'data_service_widget': 'powerdns'", view)
        self.assertIn('reconfigureAct', view)
        self.assertNotIn('btn-toolbar', view)
        self.assertNotIn('serviceStatusText', view)
        self.assertNotIn('startAct', view)
        self.assertNotIn('stopAct', view)
        self.assertNotIn('restartAct', view)
    ...
    def test_service_controller_uses_native_mutable_service_contract(self):
        ...
        self.assertIn('ApiMutableServiceControllerBase', controller)
        self.assertIn("$internalServiceName = 'powerdns'", controller)
        self.assertIn("$internalServiceEnabled = 'enabled'", controller)
        self.assertIn("'status' => 'ok'", controller)
